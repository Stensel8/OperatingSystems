...
function Open-OptiFineDownloadLink {
    $optiFineDownloadUrl = "https://optifine.net/adloadx?f=OptiFine_1.20.4_HD_U_I7.jar&x=8d29"
...
$choiceMinecraft = Show-Popup "Do you want to install Minecraft for Windows 11? This will open the Microsoft Store, as scripted Minecraft installers are not supported by Microsoft."

# Check the user's choice regarding Minecraft installation
if ($choiceMinecraft -eq "Yes") {
    # Display the popup message to ask about installing OptiFine
    $choiceOptiFine = Show-Popup "Do you want to install the OptiFine plugin for Minecraft version 1.20.4?"
